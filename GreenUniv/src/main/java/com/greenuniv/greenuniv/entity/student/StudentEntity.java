...
public class StudentEntity implements BaseEntity {
    ...
    public static class StudentEntityBuilder {
        ...
        public StudentEntity build() throws IllegalArgumentException {
            ...
            return new StudentEntity(studentNumber, user, department, image, grade, semester, currentCredit, graduationCredit,
                    status, entranceType, entranceYear, entranceGrade, entranceSemester, graduationYear, supervisorProfessor);
        }
    }
}
